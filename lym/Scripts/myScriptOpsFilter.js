...
<li><a href="#" name="Stg">上 Stg</a></li>\
                        ...
                        if(content.id == jsonData.JenkinsBuildNo&& content.service == jsonData.Service){
                            ...
                            if(promoteFlag){
                                ...
                                var deployFun = async function(){
                                    ...
                                    $('.product-owner').val('jianlin.xu@partner.bmw.com');
    ...
    var confirmCopy = function (type) {
        ...
        var mailto = 'Zhang Lei<Lei.SH.Zhang@partner.bmw.com>; Kang Lianbo, (Lianbo.Kang@partner.bmw.com); Xu Jianlin, (Jianlin.Xu@partner.bmw.com);';
